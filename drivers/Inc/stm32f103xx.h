 ...
 */
#define SPI2_I2S_BASE_ADDR	(APB1PERIPH_BASE +  0x3800)
#define SPI3_I2S_BASE_ADDR	(APB1PERIPH_BASE +  0x3C00)
 ...
 */
#define AFIO_BASE_ADDR		(APB2PERIPH_BASE +  0x0000)
#define EXTI_BASE_ADDR		(APB2PERIPH_BASE +  0x0400)

#define GPIOA_BASE_ADDR		(APB2PERIPH_BASE +  0x0800)
#define GPIOB_BASE_ADDR		(APB2PERIPH_BASE +  0x0C00)
#define GPIOC_BASE_ADDR		(APB2PERIPH_BASE +  0x1000)
#define GPIOD_BASE_ADDR		(APB2PERIPH_BASE +  0x1400)
#define GPIOE_BASE_ADDR		(APB2PERIPH_BASE +  0x1800)
#define GPIOF_BASE_ADDR		(APB2PERIPH_BASE +  0x1C00)
#define GPIOG_BASE_ADDR		(APB2PERIPH_BASE +  0x2000)

#define SPI1_BASE_ADDR		(APB2PERIPH_BASE +  0x2000)
